...
const Service = ({}) => {
  ...
  switch (service.id) {
    case "creation-de-contenu":
      ...
      var image_src = "/assets/logo/serviceMarketing.svg";
      var Contents = [
        {
          title: "identité",
    ...
    case "social-media":
      ...
      var image_src = "/assets/logo/SocialDashboard.svg";
      var Contents = [
        {
    ...
    case "website":
      ...
      var image_src = "/assets/logo/WebsiteCreator.svg";
      var Contents = [
        {
          title: "Sur mesure",
    ...
    //   var image_src = "/assets/logo/seodashboard.svg";
    //   var Contents = [
    //     {
    ...
    case "Optimisation-Web":
      ...
      var image_src = "/assets/logo/optimisation.svg";
      var Contents = [
        {
    ...
    case "Digital-business-card":
      ...
      var image_src = "/assets/logo/businessCard.svg";
      var Contents = [
        {
