    ...
    {slice?.items?.map(
      (item, i /* import { PrismicRichText } from '@prismicio/react' */) => (
        <Container key={i} className="mx-5">
          ...
          <h1 className="pb-5 font-semibold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E00] to-[#FF7E00]/50">
            <PrismicRichText field={item.title} />
          </h1>
          <Container className="font-light leading-6 text-lg mb-7">
