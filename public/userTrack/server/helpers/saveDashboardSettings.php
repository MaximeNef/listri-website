<?php
    ...
    try { checkPermission('CHANGE_DASHBOARD_SETTINGS'); } catch(Exception $e) { die($e->getMessage());}
    ...
    $query = "INSERT INTO ust_meta (`key`, `value`) 
                VALUES('DASHBOARD_SETTINGS', :settings) 
    ...
    include '../helpers/customization/updateLogoFromDB.php';
    updateLogoFromDB();